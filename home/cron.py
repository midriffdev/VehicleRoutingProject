...
def final_warning_emails():
    ...
    for i in orders:
        html_message = render_to_string('home/orderemail.html', {'user': i.email})
        try: send_mail('Order delivered to you successfully.', strip_tags(html_message), settings.EMAIL_HOST_USER, [i.email,], html_message=html_message)
